...
gui.add(material.uniforms.uShadowRepetitions, 'value').min(1).max(300).step(1).name('uShadowRepetitions')
gui
...
gui.add(material.uniforms.uLightRepetitions, 'value').min(1).max(300).step(1).name('uLightRepetitions')
gui
